    ...
    <div class="container card my-5 p-4">
        <div class="card-body">
            ...
            <div class="d-flex my-5">
                ...
                <div class="ms-3">
                    <h5 class="text-secondary">{{ $ticket['schedule']['movie']['name'] }}</h5>
            ...
            <table>
                <tr>
                    ...
                    {{-- Implode : mengubah array menjadi string, dipisahkan dengan tanda tertentu --}}
...
@push('script')
    <script>
        ...
        function selectPromo() {
            // update promoId diatas menjadi value dari select id="promo_id"
        ...
        function createQrcode() {
            ...
            $.ajax({
                ...
                error: function(message) {
                    alert('Gagal membuat qrcode pemabayarn!');
                }
            })
        }
    </script>
